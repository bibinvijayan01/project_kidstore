...
urlpatterns = [
    ...
    path('auth/', views.login_register_view, name='login_register'),  # Combined Login + Register
    ...
    path('login-register/', views.login_register_view, name='login_register'),  # Combined Login + Register
]
